<?php
// $Id: brokenfile.php,v 1.10 2004/12/26 19:11:55 onokazu Exp $
//  ------------------------------------------------------------------------ //
...
if (!empty($_POST['submit'])) {
	...
	$tags = array();
	$tags['BROKENREPORTS_URL'] = ICMS_URL . '/modules/' . $icmsModule->getVar('dirname') . '/admin/index.php?op=listBrokenDownloads';
