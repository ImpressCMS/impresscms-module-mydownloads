<?php
// $Id: mydownloads_top.php,v 1.11 2004/12/26 19:11:55 onokazu Exp $
//  ------------------------------------------------------------------------ //
...
function b_mydownloads_top_show($options) {
	...
	require_once XOOPS_ROOT_PATH."/modules/mydownloads/include/functions.php";
	$sql = "SELECT lid, cid, title, date, hits FROM ".$xoopsDB->prefix('mydownloads_downloads').' WHERE status > 0 ';
