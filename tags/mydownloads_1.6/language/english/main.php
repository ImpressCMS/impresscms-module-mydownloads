...
// Ajout Hervé
define("_MD_UPLOAD_FILE","Or select a file to upload:");
define('_MD_UPLOAD_ERROR','Error while uploading the file');
define("_MD_SUMMARY","Summary");
define("_AM_MD_GO_TO_MODULE","Go to the module");
define("_AM_MD_ADMINISTRATION", "Administration");
define("_AM_MD_DEL_ITEM", "Do you really want to delete this item ?");

// Version 1.5
define("_MD_PERM_VIEW", "Permission to view");
define("_MD_PERM_VIEW_DSC", "Select the groups who can view each category");
define("_MD_PERM_SUBMIT", "Permission to submit");
define("_MD_PERM_SUBMIT_DSC", "Select the groups who can submit files inside categories");
?>